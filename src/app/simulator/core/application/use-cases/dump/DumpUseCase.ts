...
export class DumpUseCase {
  ...
  execute(type: DumpType): void {
   ...
   private dumpBinary(simulation: any): void {
    ...
    this.file.saveText('program.bin', content, 'text/plain;charset=utf-8');
  ...
  private dumpHex(simulation: any): void {
    ...
    this.file.saveText('program.hex', content, 'text/plain;charset=utf-8');
  ...
  private dumpText(simulation: any): void {
    ...
    this.file.saveText('program.txt', content, 'text/plain;charset=utf-8');
